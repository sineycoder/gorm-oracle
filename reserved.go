...
import "github.com/sineycoder/gorm-oracle/utils/slices"

var ReservedWords = slices.ToBoolMap(ReservedWordsList)

func IsReservedWord(v string) bool {
	return ReservedWords[v]
}

// ReservedWordsList oracle reserved field (保留字段)
